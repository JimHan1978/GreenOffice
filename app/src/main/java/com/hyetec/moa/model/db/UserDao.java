...
//    Flowable<List<UserEntity>>  getUserAll(boolean delFlag);
    ...
    @Query("SELECT  userId,userName,User.sortNo,User.deptName,User.code,User.orgId,deptId,User.delFlag,email,User.positionId,User.orgName,photo,mobile,User.delFlag," +
