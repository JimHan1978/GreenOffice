...
public class AppBaseUtil {
    ...
    public static String getImei(Context context, String imei) {
        ...
        try {
            ...
            if (ActivityCompat.checkSelfPermission(MoaApp.mContext, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
			...
			Logger.e(AppBaseUtil.class.getSimpleName(), e.getMessage());
		}
