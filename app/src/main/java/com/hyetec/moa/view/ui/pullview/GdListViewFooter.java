...
/**
 * 名称：GdListViewFooter.java
 * 描述：加载更多Footer View类.
 */
public class GdListViewFooter extends LinearLayout {
	 ...
	 */
	public GdListViewFooter(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public GdListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	...
	private void initView(Context context) {
		...
		footerView.setMinimumHeight(GdViewUtil.scale(mContext,100));
		footerTextView = new TextView(context);
		footerTextView.setGravity(Gravity.CENTER_VERTICAL);
		setTextColor(Color.rgb(107, 107, 107));
		GdViewUtil.setTextSize(footerTextView,30);
		
		GdViewUtil.setPadding(footerView, 0, 10, 0, 10);
		...
		layoutParamsWW.rightMargin = GdViewUtil.scale(mContext, 10);
