...
/**
 * 名称：GdLoadDialogFragment.java 
 * 描述：弹出加载框
 */
public class GdLoadDialogFragment extends GdDialogFragment {
	 ...
	 * argument.
	 */
	public static GdLoadDialogFragment newInstance(int style, int theme) {
		GdLoadDialogFragment f = new GdLoadDialogFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		parent.setMinimumWidth(GdViewUtil.scale(this.getActivity(), 400));
