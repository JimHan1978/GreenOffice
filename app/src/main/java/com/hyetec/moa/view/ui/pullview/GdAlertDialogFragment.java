...
/**
 * 名称：GbAlertDialogFragment.java
 * 描述：弹出框
 */
public class GdAlertDialogFragment extends DialogFragment {
	 ...
	 */
	public static GdAlertDialogFragment newInstance(int icon, String title, String message, View view, AbDialogOnClickListener onClickListener) {
		GdAlertDialogFragment f = new GdAlertDialogFragment();
