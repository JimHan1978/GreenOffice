 ...
 * 描述：弹出框
 */
public class GdSampleDialogFragment extends DialogFragment {
	 ...
	 * argument.
	 */
	public static GdSampleDialogFragment newInstance(int style, int theme) {
		GdSampleDialogFragment f = new GdSampleDialogFragment();
