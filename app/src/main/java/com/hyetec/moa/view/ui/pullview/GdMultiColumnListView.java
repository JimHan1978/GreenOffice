 ...
 */
public class GdMultiColumnListView extends ScrollView {
	...
	/**  Adapter. */
	private GdMultiColumnListAdapter mAdapter = null;
	
	/**  Adapter改变的监听器. */
	private AdapterDataSetObserver mDataSetObserver;
	
	/**  已加载的View. */
	private List<GdViewInfo> mItems = null;
	 ...
	 */
	public GdMultiColumnListView(Context context) {
		this(context,null);
	}
	 ...
	 */
	public GdMultiColumnListView(Context context, AttributeSet attrs) {
	 ...
	 */
	public GdMultiColumnListView(Context context, AttributeSet attrs, int defStyle) {
		...
		mItems = new ArrayList<GdViewInfo>();
	}
	 ...
	 * @return the adapter
	 */
	public GdMultiColumnListAdapter getAdapter() {
		return mAdapter;
	}
	 ...
	 */
	public void setAdapter(GdMultiColumnListAdapter adapter) {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		//GdLogUtil.d(AbMultiColumnListView.class, "onLayout");
		if (changed && !loadOnce) {
    ...
    protected void layoutChildren() {
    	GdLogUtil.d(GdMultiColumnListView.class, "layoutChildren");
    	...
    	if(mAdapter != null){
    		...
    		for (int i = 0; i < mItemCount; i++) {
				GdViewInfo viewInfo = mAdapter.getView(i, null, null);
    ...
    protected void addChildren() {
    	GdLogUtil.d(GdMultiColumnListView.class, "addChildren");
    	if(mAdapter != null){
	 ...
	 */
	private void findColumnToAdd(GdViewInfo viewInfo) {
	...
	public boolean checkVisibility(int position) {
		GdViewInfo viewInfo = mItems.get(position);
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			GdLogUtil.d(GdMultiColumnListView.class, "onChanged");
			//判断是刷新还是添加
    		int count = mAdapter.getCount();
    		if(count > mItems.size()){
    			//添加
